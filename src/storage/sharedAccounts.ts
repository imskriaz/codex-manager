...
export function previewSharedEntry(entry: SharedCodexManagerAccountJson): { storageId?: string; email?: string } {
...
export function resolveSharedAccountIdentity(entry: SharedCodexManagerAccountJson): {
  email?: string;
  accountId?: string;
...
export function restoreSharedTokens(entry: SharedCodexManagerAccountJson): CodexTokens {
...
export function fromSharedQuotaError(
  quotaError: SharedCodexManagerAccountJson["quota_error"]
): CodexManagerAccountRecord["quotaError"] | undefined {
...
function toSharedQuota(summary?: CodexQuotaSummary): SharedCodexManagerAccountJson["quota"] {
  if (!summary) {
    return null;
  }
