import type { CodexManagerAccountRecord, CodexTokens, DecodedAuthClaims } from "../core/types";
...
export function shouldRepairWorkspaceMetadata(account: CodexManagerAccountRecord, planType?: string): boolean {
...
export function reconcileStatusBarSelections(
  index: { accounts: CodexManagerAccountRecord[] },
  nextActiveId: string,
...
export function buildAccountRecordDraft(params: {
  ...
  existing?: CodexManagerAccountRecord;
  existingAccounts: CodexManagerAccountRecord[];
