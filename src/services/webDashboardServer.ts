...
function dashboardPage(showLogout: boolean, version: string): string {
  ...
  return `<!DOCTYPE html><html lang="en" data-theme="auto" data-dashboard-host="browser" data-dashboard-remote="${showLogout ? "true" : "false"}"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#0d1117"><title>Codex Manager</title><link rel="icon" href="/assets/codex.svg" type="image/svg+xml"><link rel="apple-touch-icon" href="/assets/icon-192.png"><link rel="manifest" href="/manifest.webmanifest?v=${assetVersion}"><link rel="stylesheet" href="/assets/shared.css?v=${assetVersion}"><link rel="stylesheet" href="/assets/dashboard.css?v=${assetVersion}"></head><body><div id="app"></div><script src="/assets/browserHost.js?v=${assetVersion}"></script><script src="/assets/dashboard.js?v=${assetVersion}"></script></body></html>`;
}
