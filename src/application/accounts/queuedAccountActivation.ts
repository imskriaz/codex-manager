...
function compareQueuedAccounts(left: CodexManagerAccountRecord, right: CodexManagerAccountRecord): number {
  return compareCodexManagerAccountAutoQueueOrder(left, right) || left.createdAt - right.createdAt;
}
