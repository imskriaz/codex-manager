...
export function parseSharedJsonInput(
...
): SharedCodexManagerAccountJson | SharedCodexManagerAccountJson[] | CodexManagerBackup {
  ...
  try {
    return JSON.parse(normalized) as SharedCodexManagerAccountJson | SharedCodexManagerAccountJson[];
  } catch (error) {
