...
const PROJECT_GITHUB_URL = "https://github.com/imskriaz/codex-manager";
const PROJECT_ISSUES_URL = "https://github.com/imskriaz/codex-manager/issues";
const PROJECT_LICENSE_URL = "https://github.com/imskriaz/codex-manager/blob/master/LICENSE";
...
const ABOUT_TEXT: Record<"en" | "zh" | "zh-hant", AboutLocaleText> = {
  en: {
    ...
    subdesc:
      "Codex Manager focuses on saved accounts you already own, helping you organize tokens, inspect quotas, switch accounts, and keep account state easier to understand.",
    github: "Repository",
  ...
  zh: {
    ...
    subdesc:
      "Codex Manager 面向你已合法拥有的账号，提供本地导入、账号切换、配额查看、标签整理、导出与状态提示等能力。",
    github: "开源仓库",
    githubDesc: "查看源代码",
    feedback: "意见反馈",
  ...
  "zh-hant": {
    ...
    subdesc:
      "Codex Manager 面向你已合法擁有的帳號，提供本機匯入、帳號切換、配額查看、標籤整理、匯出與狀態提示等能力。",
    github: "開源倉庫",
    githubDesc: "查看原始碼",
    feedback: "意見回饋",
    ...
    >
      <div class="about-card">
        <section class="about-hero">
          <img class="about-logo" src={props.logoUri} alt="Codex Manager logo" width="72" height="72" />
