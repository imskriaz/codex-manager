  ...
  return (
    <div class="metric-gauge">
      <div class="metric-gauge-head">
        ...
        <span class="metric-gauge-reset" title={props.placeholder ? "" : resetLabel}>
          {props.placeholder ? "\u00a0" : resetLabel}
        </span>
        <div class="metric-gauge-value">{props.placeholder ? "\u00a0" : formatPercent(props.metric.percentage)}</div>
      </div>
      <div class="bar metric-gauge-bar" style={style}>
        <span style={{ width: props.placeholder ? "0" : `${clamped}%`, "--metric-color": color }}></span>
      </div>
    </div>
  );
}
